...
class JurusanController extends Controller
{
    public function index(Request $request)
    {
        ...
        $jurusan_cari = $query->get();
        // $jurusan = DB::table('jurusan')->orderBy('kode_jurusan')->get();

        $dataKosong = $jurusan_cari->isEmpty(); 
        $sudahCari = !empty($nama_jurusan);
        
        return view('jurusan.index', compact('jurusan','jurusan_cari','dataKosong','sudahCari'));
    }
