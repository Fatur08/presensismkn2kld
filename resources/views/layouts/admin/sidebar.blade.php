      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/presensi/rekappresensi" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/presensi/rekapharian" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/presensi/rekapbulan" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item">
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a class="nav-link" href="/konfigurasi/lokasisekolah" style="margin-left: 26px;">
                  <span class="nav-link-icon d-md-none d-lg-inline-block">
